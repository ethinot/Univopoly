...
QT_MOC_LITERAL(6, 8), // "endLobby"
QT_MOC_LITERAL(15, 0), // ""
QT_MOC_LITERAL(16, 12) // "endLobbySLOT"

    },
    "Lobby\0endLobby\0\0endLobbySLOT"
};
...
void Lobby::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->endLobby((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->endLobbySLOT(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Lobby::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Lobby::endLobby)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Lobby::staticMetaObject = { {
    ...
    qt_meta_stringdata_Lobby.offsetsAndSize,
    qt_meta_data_Lobby,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Lobby_t
, QtPrivate::TypeAndForceComplete<Lobby, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
