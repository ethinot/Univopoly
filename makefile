#############################################################################
# Makefile for building: univopoly_qt.app/Contents/MacOS/univopoly_qt
...
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=11 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
DESTDIR       = 
TARGET        = univopoly_qt.app/Contents/MacOS/univopoly_qt
...
univopoly_qt.app/Contents/MacOS/univopoly_qt:  $(OBJECTS)  
	@test -d univopoly_qt.app/Contents/MacOS/ || mkdir -p univopoly_qt.app/Contents/MacOS/
...
univopoly_qt.app/Contents/PkgInfo: 
	@test -d univopoly_qt.app/Contents || mkdir -p univopoly_qt.app/Contents
	@$(DEL_FILE) univopoly_qt.app/Contents/PkgInfo
	@echo "APPL????" > univopoly_qt.app/Contents/PkgInfo
univopoly_qt.app/Contents/Resources/empty.lproj: 
	@test -d univopoly_qt.app/Contents/Resources || mkdir -p univopoly_qt.app/Contents/Resources
	@touch univopoly_qt.app/Contents/Resources/empty.lproj
	
univopoly_qt.app/Contents/Info.plist: 
	@test -d univopoly_qt.app/Contents || mkdir -p univopoly_qt.app/Contents
	@$(DEL_FILE) univopoly_qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.nzo.univopoly-qt,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.nzo.univopoly-qt,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,univopoly_qt,g" -e "s,@LIBRARY@,univopoly_qt,g" -e "s,\$${EXECUTABLE_NAME},univopoly_qt,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >univopoly_qt.app/Contents/Info.plist

all: Makefile \
		univopoly_qt.app/Contents/PkgInfo \
		univopoly_qt.app/Contents/Resources/empty.lproj \
		univopoly_qt.app/Contents/Info.plist univopoly_qt.app/Contents/MacOS/univopoly_qt
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=11 -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
main_qt.o: src/qt/main_qt.cpp /usr/local/lib/QtWidgets.framework/Headers/QApplication \
