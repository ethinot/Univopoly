...
#include <memory>
#include "src/qt/extensions/components/sideBar/Players.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Players_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Players_t qt_meta_stringdata_Players = {
    {
QT_MOC_LITERAL(0, 7), // "Players"
QT_MOC_LITERAL(8, 6), // "render"
QT_MOC_LITERAL(15, 0), // ""
QT_MOC_LITERAL(16, 19), // "std::vector<Player>"
QT_MOC_LITERAL(36, 9) // "rendering"

    },
    "Players\0render\0\0std::vector<Player>\0"
    "rendering"
};
...
void Players::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Players::*)(std::vector<Player> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Players::render)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Players::staticMetaObject = { {
    ...
    qt_meta_stringdata_Players.offsetsAndSize,
    qt_meta_data_Players,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Players_t
, QtPrivate::TypeAndForceComplete<Players, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<std::vector<Player>, std::false_type>
...
// SIGNAL 0
void Players::render(std::vector<Player> _t1)
{
