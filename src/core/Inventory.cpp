...
Tile* Inventory::getProperty(int property_id) { return collection[property_id];}
void Inventory::addProperty(int property_id, Tile* new_property) {collection.insert(std::pair<unsigned int, Tile*>(property_id, new_property));}
